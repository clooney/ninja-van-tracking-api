J&T Tracking API - .Net
================================
Use .Net to track J&T shipments with J&T Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "941699173940";
                  createTrackingParams.courierCode = "jet";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "JO0305615527,JO0305919548";
                  getTrackingResultsParams.courierCode = "jet";
