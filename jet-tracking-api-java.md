J&T Tracking API - Java
================================
Use Java to track J&T shipments with J&T Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.jet;
    ...
    public class CreateJETTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("941699173940");
                createTrackingParams.setCourierCode("jet");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateJETTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("JO0305919548");
                createTrackingParams1.setCourierCode("jet");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("JO0305615527");
                createTrackingParams2.setCourierCode("jet");
...
Get status of the shipment:
    ...
    public class GetJETTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("JO0305615527,JO0305919548");
                trackingParams.setCourierCode("jet");
...
Update a tracking by ID:
    ...
    public class UpdateJETTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "97a7ca4693ea905a1892ec01704633d3";
